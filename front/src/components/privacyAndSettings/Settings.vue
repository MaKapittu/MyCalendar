<template>
    <div class="Centered">
        <div>Unfortunatelly, settings page is not available yet!</div>
    </div>
    <div class="snow-ball">
...
<div class="text">While you wait, why not watch our dazzling animation?</div>
